...
import cloudyWShowers from "../assets/cloudy/cloudy.png";
import cloudyWHeavyShowers from "../assets/cloudy/cloudy.png";
    ...
    const getWeatherIcon = (day, text) => {
        if(day > 0) {
            switch(text) {
                ...
                case "Cloudy":
                    return cloudy;
                case "Cloudy with light showers" || "Cloudy with showers":
                    return cloudyDay;
